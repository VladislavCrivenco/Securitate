namespace Crypto
{
    ...
    {
        private static int BlockSize = 48;

        private static byte[] message_expansion = {
                            32,  1,  2,  3,  4,  5,
                             4,  5,  6,  7,  8,  9,
                             8,  9, 10, 11, 12, 13,
                            12, 13, 14, 15, 16, 17,
    ...
    2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11
        ...
        public static bool[] Compute(bool[] input, bool[] key)
        {
            return new bool[3];
        }

        private static bool[] Expand(bool[] input)
        {
            var result = new bool[BlockSize];

            for (int i = 0; i < result.Length; i++)
            {
                result[i] = input[message_expansion[i]];
            }
